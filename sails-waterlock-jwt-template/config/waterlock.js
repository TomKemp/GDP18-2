...
module.exports.waterlock = {
  ...
  authMethod: [
    ...
    {
      name:'waterlock-blackboard-auth-with-refresh',
      service_name:"Synote",
      provider:[
        {
          id:"blackboard",
          ...
          panopto:{
            secret:"panopto key",
            bounce:"https://blackboard.university.soton.ac.uk/webapps/ppto-PanoptoCourseTool-BBLEARN/SSO.jsp",
            serverName:"coursecast.university.ac.uk"
          },
          fieldMap:{
